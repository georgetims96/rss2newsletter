...
from feedaggregator.views import EntryDetailView, EntrySavedView, EntryUnsaveView, FeedFormView, FeedDiscoverView, FeedSubscribeView, FeedSubscriptionView, FeedUnsubscribeView, EntryListView, EntrySaveView
